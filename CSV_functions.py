...
MUSICGLOVE = 'Z:\\resources\\saves\\temp\\temp.csv'                                         # CalPlug server
#MUSICGLOVE = 'C:\\Users\\Nathan\\Desktop\\Calit2Dev\\MG\\musicglove_1366x768\\resources\\saves\\temp\\temp.csv' # Local Computer

### Sets a unique timestamped filename, in the summaries directory, for the stats of the current song
M_GLOVE_SUMMARIES = "Z:\\summaries\\"                                     # CalPlug server
#M_GLOVE_SUMMARIES = "C:\\Users\\Nathan\\Desktop\\Calit2Dev\\MG\\musicglove_1366x768\\summaries\\" # Local Computer
